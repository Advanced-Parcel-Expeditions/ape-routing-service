package si.ape.routing.models.entities;
...
@NamedQueries(value =
        {
            ...
            @NamedQuery(name = "BranchEntity.getAllWithType",
                query = "SELECT b FROM BranchEntity b WHERE b.branchType.id = :branchTypeId"),
        })
